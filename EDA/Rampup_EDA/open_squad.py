...
class SquadProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, epoch, filename=None):
        """
        ...
        return self._create_examples(input_data, "train", epoch)
    ...
    def _create_examples(self, input_data, set_type, epoch=0):
        ...
        for entry in tqdm(input_data[:]):
            ...
            for pi, paragraph in enumerate(entry["paragraphs"]):
                ...
                if is_training:
                    if is_impossible:
                        aug_context_text = eda_context(context_text,answer_text,alpha_rs=epoch*0.01, alpha_rdu=epoch*0.01, p_rd=epoch*0.01)
                    else:
                        # print("\nbefore context")
                        # print(context_text)
                        ...
                        for ct in context_text_list:
                            aug_context_text_list.append(eda_context(ct,answer_text,alpha_rs=epoch*0.01, alpha_rdu=epoch*0.01, p_rd=epoch*0.01))
